...
public class X837Pro_2010CA_DMG_PatientDemographicInformation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"X837Pro_2010CA_DMG_PatientDemographicInformation\",\"namespace\":\"net.explorys.samhat.z12.r837\",\"fields\":[{\"name\":\"_2010CADMG01DateTimePeriodFormatQualifier\",\"type\":\"string\"},{\"name\":\"_2010CADMG02PatientBirthDate\",\"type\":\"string\"},{\"name\":\"_2010CADMG03PatientGenderCode\",\"type\":\"string\"}]}");
   ...
   */
  public X837Pro_2010CA_DMG_PatientDemographicInformation() {}

  /**
   * All-args constructor.
   */
  public X837Pro_2010CA_DMG_PatientDemographicInformation(java.lang.CharSequence _2010CADMG01DateTimePeriodFormatQualifier, java.lang.CharSequence _2010CADMG02PatientBirthDate, java.lang.CharSequence _2010CADMG03PatientGenderCode) {
  ...
  /** Creates a new X837Pro_2010CA_DMG_PatientDemographicInformation RecordBuilder */
  public static net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder newBuilder() {
    return new net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder();
  }
  
  /** Creates a new X837Pro_2010CA_DMG_PatientDemographicInformation RecordBuilder by copying an existing Builder */
  public static net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder other) {
    return new net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder(other);
  }
  
  /** Creates a new X837Pro_2010CA_DMG_PatientDemographicInformation RecordBuilder by copying an existing X837Pro_2010CA_DMG_PatientDemographicInformation instance */
  public static net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation other) {
    return new net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder(other);
  }
  
  /**
   * RecordBuilder for X837Pro_2010CA_DMG_PatientDemographicInformation instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<X837Pro_2010CA_DMG_PatientDemographicInformation>
    implements org.apache.avro.data.RecordBuilder<X837Pro_2010CA_DMG_PatientDemographicInformation> {
    ...
    private Builder() {
      super(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing X837Pro_2010CA_DMG_PatientDemographicInformation instance */
    private Builder(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation other) {
            super(net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.SCHEMA$);
      if (isValidValue(fields()[0], other._2010CADMG01DateTimePeriodFormatQualifier)) {
        this._2010CADMG01DateTimePeriodFormatQualifier = data().deepCopy(fields()[0].schema(), other._2010CADMG01DateTimePeriodFormatQualifier);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the '_2010CADMG01DateTimePeriodFormatQualifier' field */
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder set2010CADMG01DateTimePeriodFormatQualifier$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder clear2010CADMG01DateTimePeriodFormatQualifier$1() {
    ...
    /** Sets the value of the '_2010CADMG02PatientBirthDate' field */
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder set2010CADMG02PatientBirthDate$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder clear2010CADMG02PatientBirthDate$1() {
    ...
    /** Sets the value of the '_2010CADMG03PatientGenderCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder set2010CADMG03PatientGenderCode$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2010CA_DMG_PatientDemographicInformation.Builder clear2010CADMG03PatientGenderCode$1() {
    ...
    @Override
    public X837Pro_2010CA_DMG_PatientDemographicInformation build() {
      try {
        X837Pro_2010CA_DMG_PatientDemographicInformation record = new X837Pro_2010CA_DMG_PatientDemographicInformation();
