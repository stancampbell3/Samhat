...
public class X837Ins_2400_DTP_ServiceLineDate extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"X837Ins_2400_DTP_ServiceLineDate\",\"namespace\":\"net.explorys.samhat.z12.r837\",\"fields\":[{\"name\":\"_2400DTP01DateTimeQualifier\",\"type\":\"string\"},{\"name\":\"_2400DTP02DateTimePeriodFormatQualifier\",\"type\":\"string\"},{\"name\":\"_2400DTP03ServiceDate\",\"type\":\"string\"}]}");
   ...
   */
  public X837Ins_2400_DTP_ServiceLineDate() {}

  /**
   * All-args constructor.
   */
  public X837Ins_2400_DTP_ServiceLineDate(java.lang.CharSequence _2400DTP01DateTimeQualifier, java.lang.CharSequence _2400DTP02DateTimePeriodFormatQualifier, java.lang.CharSequence _2400DTP03ServiceDate) {
  ...
  /** Creates a new X837Ins_2400_DTP_ServiceLineDate RecordBuilder */
  public static net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder newBuilder() {
    return new net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder();
  }
  
  /** Creates a new X837Ins_2400_DTP_ServiceLineDate RecordBuilder by copying an existing Builder */
  public static net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder newBuilder(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder other) {
    return new net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder(other);
  }
  
  /** Creates a new X837Ins_2400_DTP_ServiceLineDate RecordBuilder by copying an existing X837Ins_2400_DTP_ServiceLineDate instance */
  public static net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder newBuilder(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate other) {
    return new net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder(other);
  }
  
  /**
   * RecordBuilder for X837Ins_2400_DTP_ServiceLineDate instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<X837Ins_2400_DTP_ServiceLineDate>
    implements org.apache.avro.data.RecordBuilder<X837Ins_2400_DTP_ServiceLineDate> {
    ...
    private Builder() {
      super(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing X837Ins_2400_DTP_ServiceLineDate instance */
    private Builder(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate other) {
            super(net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.SCHEMA$);
      if (isValidValue(fields()[0], other._2400DTP01DateTimeQualifier)) {
        this._2400DTP01DateTimeQualifier = data().deepCopy(fields()[0].schema(), other._2400DTP01DateTimeQualifier);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the '_2400DTP01DateTimeQualifier' field */
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder set2400DTP01DateTimeQualifier$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder clear2400DTP01DateTimeQualifier$1() {
    ...
    /** Sets the value of the '_2400DTP02DateTimePeriodFormatQualifier' field */
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder set2400DTP02DateTimePeriodFormatQualifier$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder clear2400DTP02DateTimePeriodFormatQualifier$1() {
    ...
    /** Sets the value of the '_2400DTP03ServiceDate' field */
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder set2400DTP03ServiceDate$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2400_DTP_ServiceLineDate.Builder clear2400DTP03ServiceDate$1() {
    ...
    @Override
    public X837Ins_2400_DTP_ServiceLineDate build() {
      try {
        X837Ins_2400_DTP_ServiceLineDate record = new X837Ins_2400_DTP_ServiceLineDate();
