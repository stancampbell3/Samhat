...
public class X837Ins_2010BA_DMG_SubscriberDemographicInformation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"X837Ins_2010BA_DMG_SubscriberDemographicInformation\",\"namespace\":\"net.explorys.samhat.z12.r837\",\"fields\":[{\"name\":\"_2010BADMG01DateTimePeriodFormatQualifier\",\"type\":\"string\"},{\"name\":\"_2010BADMG02SubscriberBirthDate\",\"type\":\"string\"},{\"name\":\"_2010BADMG03SubscriberGenderCode\",\"type\":\"string\"}]}");
   ...
   */
  public X837Ins_2010BA_DMG_SubscriberDemographicInformation() {}

  /**
   * All-args constructor.
   */
  public X837Ins_2010BA_DMG_SubscriberDemographicInformation(java.lang.CharSequence _2010BADMG01DateTimePeriodFormatQualifier, java.lang.CharSequence _2010BADMG02SubscriberBirthDate, java.lang.CharSequence _2010BADMG03SubscriberGenderCode) {
  ...
  /** Creates a new X837Ins_2010BA_DMG_SubscriberDemographicInformation RecordBuilder */
  public static net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder newBuilder() {
    return new net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder();
  }
  
  /** Creates a new X837Ins_2010BA_DMG_SubscriberDemographicInformation RecordBuilder by copying an existing Builder */
  public static net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder other) {
    return new net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder(other);
  }
  
  /** Creates a new X837Ins_2010BA_DMG_SubscriberDemographicInformation RecordBuilder by copying an existing X837Ins_2010BA_DMG_SubscriberDemographicInformation instance */
  public static net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation other) {
    return new net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder(other);
  }
  
  /**
   * RecordBuilder for X837Ins_2010BA_DMG_SubscriberDemographicInformation instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<X837Ins_2010BA_DMG_SubscriberDemographicInformation>
    implements org.apache.avro.data.RecordBuilder<X837Ins_2010BA_DMG_SubscriberDemographicInformation> {
    ...
    private Builder() {
      super(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing X837Ins_2010BA_DMG_SubscriberDemographicInformation instance */
    private Builder(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation other) {
            super(net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.SCHEMA$);
      if (isValidValue(fields()[0], other._2010BADMG01DateTimePeriodFormatQualifier)) {
        this._2010BADMG01DateTimePeriodFormatQualifier = data().deepCopy(fields()[0].schema(), other._2010BADMG01DateTimePeriodFormatQualifier);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the '_2010BADMG01DateTimePeriodFormatQualifier' field */
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder set2010BADMG01DateTimePeriodFormatQualifier$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder clear2010BADMG01DateTimePeriodFormatQualifier$1() {
    ...
    /** Sets the value of the '_2010BADMG02SubscriberBirthDate' field */
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder set2010BADMG02SubscriberBirthDate$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder clear2010BADMG02SubscriberBirthDate$1() {
    ...
    /** Sets the value of the '_2010BADMG03SubscriberGenderCode' field */
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder set2010BADMG03SubscriberGenderCode$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Ins_2010BA_DMG_SubscriberDemographicInformation.Builder clear2010BADMG03SubscriberGenderCode$1() {
    ...
    @Override
    public X837Ins_2010BA_DMG_SubscriberDemographicInformation build() {
      try {
        X837Ins_2010BA_DMG_SubscriberDemographicInformation record = new X837Ins_2010BA_DMG_SubscriberDemographicInformation();
