...
public class X837Pro_2000B_SBR_SubscriberInformation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"X837Pro_2000B_SBR_SubscriberInformation\",\"namespace\":\"net.explorys.samhat.z12.r837\",\"fields\":[{\"name\":\"_2000BSBR01PayerResponsibilitySequenceNumberCode\",\"type\":\"string\"},{\"name\":\"_2000BSBR02IndividualRelationshipCode\",\"type\":\"string\"},{\"name\":\"_2000BSBR03InsuredGroupOrPolicyNumber\",\"type\":\"string\"},{\"name\":\"_2000BSBR04InsuredGroupName\",\"type\":\"string\"},{\"name\":\"_2000BSBR05InsuranceTypeCode\",\"type\":\"string\"},{\"name\":\"_2000BSBR09ClaimFilingIndicatorCode\",\"type\":\"string\"}]}");
  ...
  @Deprecated public java.lang.CharSequence _2000BSBR05InsuranceTypeCode;
   ...
   */
  public X837Pro_2000B_SBR_SubscriberInformation() {}

  /**
   * All-args constructor.
   */
  public X837Pro_2000B_SBR_SubscriberInformation(java.lang.CharSequence _2000BSBR01PayerResponsibilitySequenceNumberCode, java.lang.CharSequence _2000BSBR02IndividualRelationshipCode, java.lang.CharSequence _2000BSBR03InsuredGroupOrPolicyNumber, java.lang.CharSequence _2000BSBR04InsuredGroupName, java.lang.CharSequence _2000BSBR05InsuranceTypeCode, java.lang.CharSequence _2000BSBR09ClaimFilingIndicatorCode) {
    ...
    this._2000BSBR05InsuranceTypeCode = _2000BSBR05InsuranceTypeCode;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 4: return _2000BSBR05InsuranceTypeCode;
    case 5: return _2000BSBR09ClaimFilingIndicatorCode;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: _2000BSBR05InsuranceTypeCode = (java.lang.CharSequence)value$; break;
    case 5: _2000BSBR09ClaimFilingIndicatorCode = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the '_2000BSBR05InsuranceTypeCode' field.
   */
  public java.lang.CharSequence get2000BSBR05InsuranceTypeCode$1() {
    return _2000BSBR05InsuranceTypeCode;
  }

  /**
   * Sets the value of the '_2000BSBR05InsuranceTypeCode' field.
   * @param value the value to set.
   */
  public void set2000BSBR05InsuranceTypeCode$1(java.lang.CharSequence value) {
    this._2000BSBR05InsuranceTypeCode = value;
  }
  ...
  /** Creates a new X837Pro_2000B_SBR_SubscriberInformation RecordBuilder */
  public static net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder newBuilder() {
    return new net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder();
  }
  
  /** Creates a new X837Pro_2000B_SBR_SubscriberInformation RecordBuilder by copying an existing Builder */
  public static net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder other) {
    return new net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder(other);
  }
  
  /** Creates a new X837Pro_2000B_SBR_SubscriberInformation RecordBuilder by copying an existing X837Pro_2000B_SBR_SubscriberInformation instance */
  public static net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder newBuilder(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation other) {
    return new net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder(other);
  }
  
  /**
   * RecordBuilder for X837Pro_2000B_SBR_SubscriberInformation instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<X837Pro_2000B_SBR_SubscriberInformation>
    implements org.apache.avro.data.RecordBuilder<X837Pro_2000B_SBR_SubscriberInformation> {
    ...
    private java.lang.CharSequence _2000BSBR05InsuranceTypeCode;
    private java.lang.CharSequence _2000BSBR09ClaimFilingIndicatorCode;

    /** Creates a new Builder */
    private Builder() {
      super(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[4], other._2000BSBR05InsuranceTypeCode)) {
        this._2000BSBR05InsuranceTypeCode = data().deepCopy(fields()[4].schema(), other._2000BSBR05InsuranceTypeCode);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], other._2000BSBR09ClaimFilingIndicatorCode)) {
        this._2000BSBR09ClaimFilingIndicatorCode = data().deepCopy(fields()[5].schema(), other._2000BSBR09ClaimFilingIndicatorCode);
        fieldSetFlags()[5] = true;
      }
    }
    
    /** Creates a Builder by copying an existing X837Pro_2000B_SBR_SubscriberInformation instance */
    private Builder(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation other) {
            super(net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.SCHEMA$);
      if (isValidValue(fields()[0], other._2000BSBR01PayerResponsibilitySequenceNumberCode)) {
        this._2000BSBR01PayerResponsibilitySequenceNumberCode = data().deepCopy(fields()[0].schema(), other._2000BSBR01PayerResponsibilitySequenceNumberCode);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the '_2000BSBR01PayerResponsibilitySequenceNumberCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR01PayerResponsibilitySequenceNumberCode$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR01PayerResponsibilitySequenceNumberCode$1() {
    ...
    /** Sets the value of the '_2000BSBR02IndividualRelationshipCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR02IndividualRelationshipCode$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR02IndividualRelationshipCode$1() {
    ...
    /** Sets the value of the '_2000BSBR03InsuredGroupOrPolicyNumber' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR03InsuredGroupOrPolicyNumber$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR03InsuredGroupOrPolicyNumber$1() {
    ...
    /** Sets the value of the '_2000BSBR04InsuredGroupName' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR04InsuredGroupName$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR04InsuredGroupName$1() {
    ...
    /** Sets the value of the '_2000BSBR05InsuranceTypeCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR05InsuranceTypeCode$1(java.lang.CharSequence value) {
    ...
    /** Checks whether the '_2000BSBR05InsuranceTypeCode' field has been set */
    public boolean has2000BSBR05InsuranceTypeCode$1() {
      return fieldSetFlags()[4];
    }
    
    /** Clears the value of the '_2000BSBR05InsuranceTypeCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR05InsuranceTypeCode$1() {
      _2000BSBR05InsuranceTypeCode = null;
    ...
    /** Sets the value of the '_2000BSBR09ClaimFilingIndicatorCode' field */
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder set2000BSBR09ClaimFilingIndicatorCode$1(java.lang.CharSequence value) {
    ...
    public net.explorys.samhat.z12.r837.X837Pro_2000B_SBR_SubscriberInformation.Builder clear2000BSBR09ClaimFilingIndicatorCode$1() {
    ...
    @Override
    public X837Pro_2000B_SBR_SubscriberInformation build() {
      try {
        X837Pro_2000B_SBR_SubscriberInformation record = new X837Pro_2000B_SBR_SubscriberInformation();
        ...
        record._2000BSBR05InsuranceTypeCode = fieldSetFlags()[4] ? this._2000BSBR05InsuranceTypeCode : (java.lang.CharSequence) defaultValue(fields()[4]);
        record._2000BSBR09ClaimFilingIndicatorCode = fieldSetFlags()[5] ? this._2000BSBR09ClaimFilingIndicatorCode : (java.lang.CharSequence) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {
